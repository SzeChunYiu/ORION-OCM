...
Parent freeze: `FREEZE_V1.md`, committed at `research/gmi-833-h-real-scale-revival-v1/FREEZE_V1.md`.
...
for forty thousand arbitrary denominators below `10**9` is a number with
