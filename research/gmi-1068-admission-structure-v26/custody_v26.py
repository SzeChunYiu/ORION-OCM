...
FREEZE = "c9fd15cba845e80448672b3fc65bdb7430fe8043"
FREEZE_SHA = "187d6cbcfde17126d25d199fc21a0f4369d39e2ae291fbc7b6bec9140800192c"
RECEIPTS = (
    "research/gmi-1068-guarded-foundations-v25/RESULT_V25.json",
    "research/gmi-1068-corrected-targets-v16/RESULT_V16.json",
    "research/gmi-1068-amendment-governance-v16/RESULT_V16.json",
    "research/gmi-1068-arrows-only-v19/RESULT_V19.json",
    "research/gmi-1068-foundation-repair-v5/RESULT_V5.json",
    "research/gmi-1068-optional-structure-v13/RESULT_V13.json",
    "research/gmi-1068-stochastic-process-v14/RESULT_V14.json",
)
...
def verify(root):
    ...
    frozen = git(root, "show", FREEZE + ":" + PACKAGE + "/FREEZE_V26.md")
    ...
    if inventory.stdout.decode().splitlines() != [PACKAGE + "/FREEZE_V26.md"]:
        raise ValueError("outcome artifacts already present at preregistration")
    freeze_path = root / PACKAGE / "FREEZE_V26.md"
    ...
    bindings[PACKAGE + "/FREEZE_V26.md"] = FREEZE_SHA
