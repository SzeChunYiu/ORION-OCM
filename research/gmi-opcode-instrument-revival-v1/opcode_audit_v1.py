#!/usr/bin/env python3
"""Reconstruct verdicts from registered raw executions without any candidate invocation."""
import json
...
def audit():
    ...
    for variant, initial in CELLS:
        ...
        command = [frozen["environment"]["executable"], "-I", "-B",
                   str(HERE / "opcode_revival_v1.py"), "--child", variant, initial]
    ...
    return {"schema": "opcode-instrument-revival-v1", "freeze_sha256": sha(FREEZE),
