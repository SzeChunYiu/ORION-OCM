"""G7 persistent developmental lineage — D3 successor vessel.

Continues lineage id orion-ocm-g7-lineage-v1:microscope-d0-d1 through a fourth
earned DevelopmentTransitionV1 (OCM_2 → OCM_3). D3 competence is miniature
Hilbert/SK named-lemma introduction from research/math-n4-subgoal-v2/, not
Metamath, not FLT, and not historical M11 relabel. Serialises the whole earned
...
UNRUN_STAGES = ("OCM_4", "OCM_5", "OCM_6")
