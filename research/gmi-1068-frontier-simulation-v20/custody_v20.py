...
FREEZE = "60e8edce34c8c9a3426cb406cc806416c438515f"
FREEZE_SHA = "a8b6b545c6e7503c76268c49ba6b706fc5f97dc4776313188b5194a9608420ed"
RECEIPTS = (
...
def verify(root):
    ...
    frozen = git(root, "show", FREEZE + ":" + PACKAGE + "/FREEZE_V20.md")
    ...
    if inventory.stdout.decode().splitlines() != [PACKAGE + "/FREEZE_V20.md"]:
        raise ValueError("outcome artifacts already present at preregistration")
    freeze_path = root / PACKAGE / "FREEZE_V20.md"
    ...
    bindings[PACKAGE + "/FREEZE_V20.md"] = FREEZE_SHA
