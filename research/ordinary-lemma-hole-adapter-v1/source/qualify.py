...
def main():
    ...
    argv=[str(PYTHON),"-I","-S","-B",str(ROOT/"check_slots.py"),str(output/"CONTROLS.json")]
    ...
    allowed={str(ROOT/n) for n in ("check_slots.py","authored_fixture.py","hole_match.py","replacement.py")}
