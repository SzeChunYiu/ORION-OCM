...
from proof_contract_v16 import ENTRIES, SOURCE_NAMES, SOURCE_PATHS, audit_source
...
def evaluate():
    ...
    audit = audit_source()
    try:
        with tempfile.TemporaryDirectory(prefix="gmi-v16-lean-") as output:
            ...
            audit_path = Path(output) / "RegisteredProofsV16.lean"
    ...
    return {"status": "PASS", "lean_version": "4.19.0", "sources": bindings,
            ...
            "source_assumptions": "generated typed raw histories; actual C4/V4 laws; full scalar additivity and homogeneity over primitive ordered-ring laws"}
