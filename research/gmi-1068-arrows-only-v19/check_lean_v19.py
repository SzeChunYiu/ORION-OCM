...
from proof_contract_v19 import ENTRIES, SOURCE_NAMES, SOURCE_PATHS, audit_source
...
def evaluate(source_overrides=None, require_source_compile=False):
    ...
    audit = audit_source()
    try:
        with tempfile.TemporaryDirectory(prefix="gmi-v19-lean-") as output:
            ...
            audit_path = Path(output) / "RegisteredProofsV19.lean"
