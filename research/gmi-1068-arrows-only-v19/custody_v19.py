...
FREEZE = "8b373717683b40a1352cf7f85f0e38538c709966"
FREEZE_SHA = "420f4499c111ca070906405b2986d14fef69d8f32f384769ac91b10bd9fc6dd1"
RECEIPTS = (
    "research/gmi-1068-reference-envelope-v18/RESULT_V18.json",
...
def verify(root):
    ...
    frozen = git(root, "show", FREEZE + ":" + PACKAGE + "/FREEZE_V19.md")
    ...
    if inventory.stdout.decode().splitlines() != [PACKAGE + "/FREEZE_V19.md"]:
        raise ValueError("outcome artifacts already present at preregistration")
    freeze_path = root / PACKAGE / "FREEZE_V19.md"
    ...
    bindings[PACKAGE + "/FREEZE_V19.md"] = FREEZE_SHA
