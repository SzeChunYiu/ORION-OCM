...
from proof_contract_v15 import ENTRIES, SOURCE_NAMES, SOURCE_PATHS, audit_source
...
def evaluate():
    ...
    bindings = {}
    audit = audit_source()
    with tempfile.TemporaryDirectory(prefix="gmi-v15-lean-") as output:
        ...
        audit_path = Path(output) / "RegisteredProofsV15.lean"
