...
- universe sizes, exact: `64` at `b = 0`, `16777216` at `b = 1`,
  ...
  `FREEZE_V1.md` §1a);
- `248` cost-minimising morphologies at `b = 1`, all in `F_MEALY_PURE` and in no
...
No unseen morphology is claimed: the recovered class is a Mealy machine. No W4 or
...
control and a real hostile put in its place. The first remint control did not
