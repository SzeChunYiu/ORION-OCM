"""G7 persistent developmental lineage — D5 successor vessel.

Continues lineage id orion-ocm-g7-lineage-v1:microscope-d0-d1 through a sixth
earned DevelopmentTransitionV1 (OCM_4 → OCM_5). D5 competence is a tiny
metacognition / learning-to-learn microscope: select which of two already-earned
methods to try first from a validation utility table. Not neural, not Metamath,
not FLT, and not historical M11 relabel. Serialises the whole earned bundle,
restarts by loading it, and refuses a tampered digest. Reset stores cannot read
continued-arm files. Constitution C is frozen. D6 remains unrun.
"""
        ...
        "executive_metareasoning_policy": {
            ...
            "payload": {
                "rule": (
                    ...
                    "metacognition family; do not rewrite C"
                ),
