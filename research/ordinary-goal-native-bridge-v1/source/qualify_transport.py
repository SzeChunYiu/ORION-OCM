...
def main():
    ...
    argv=[str(PYTHON),"-I","-S","-B",str(ROOT/"check_transport.py"),str(output/"CONTROLS.json")]
    ...
    passed=(pid==child.pid and child.returncode==0 and matched and imports_ok and not forbidden
        and before==after and controls["passed"] and controls["tests_run"]==2 and controls["native_calls"]==0)
