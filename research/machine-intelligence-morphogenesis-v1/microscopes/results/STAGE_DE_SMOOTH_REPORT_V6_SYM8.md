# Stage D'/E' — smooth-generalization ecology: report V6_SYM8

Target coefficients [0.5, 0.5, 0.5, 0.5]. Receipt `STAGE_DE_SMOOTH_V6_SYM8.json` (sha256 `d82e58083d52c6a5…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
...
| S5k@4 | 0.375 | 0.375 | 0.375 | 0.375 | 0.375 | 0.375 |
