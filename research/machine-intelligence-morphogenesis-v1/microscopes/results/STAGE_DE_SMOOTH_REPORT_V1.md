...
Target coefficients [0.25, 0.5, -0.25, 0.5]. Receipt `STAGE_DE_SMOOTH_V1.json` (sha256 `4a47a5be6bdbeb20…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
