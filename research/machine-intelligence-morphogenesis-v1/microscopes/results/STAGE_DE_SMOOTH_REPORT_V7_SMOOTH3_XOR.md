# Stage D'/E' — smooth-generalization ecology: report V7_SMOOTH3_XOR

Target coefficients [0.5, 0.25, -0.5, 0.375]. Receipt `STAGE_DE_SMOOTH_V7_SMOOTH3_XOR.json` (sha256 `e4fb0da30b5adaf2…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
...
| S6@4 | 0.7083 | 0.7083 | 0.7083 | 0.7083 | 0.7083 | 0.7083 |
