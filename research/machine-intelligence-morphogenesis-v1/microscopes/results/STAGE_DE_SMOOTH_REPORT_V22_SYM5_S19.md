# Stage D'/E' — smooth-generalization ecology: report V22_SYM5_S19

Target coefficients [0.3125, 0.3125, 0.3125, 0.3125]. Receipt `STAGE_DE_SMOOTH_V22_SYM5_S19.json` (sha256 `88ec528fed1a5004…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
...
| S3@8 | 0.8229 | 0.8229 | 0.8229 | 0.8229 | 0.8229 | 0.8229 |
