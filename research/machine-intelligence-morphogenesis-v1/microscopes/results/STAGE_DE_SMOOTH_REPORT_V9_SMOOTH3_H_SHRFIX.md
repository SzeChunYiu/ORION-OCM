# Stage D'/E' — smooth-generalization ecology: report V9_SMOOTH3_H_SHRFIX

Target coefficients [0.5, 0.25, -0.5, 0.375]. Receipt `STAGE_DE_SMOOTH_V9_SMOOTH3_H_SHRFIX.json` (sha256 `051ada3fd6eef8b3…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
