# Stage D'/E' — smooth-generalization ecology: report V20_SMOOTH3_S1

Target coefficients [0.5, 0.25, -0.5, 0.375]. Receipt `STAGE_DE_SMOOTH_V20_SMOOTH3_S1.json` (sha256 `1a270ed3f221b13a…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
...
| S3@8 | 0.3125 | 0.3125 | 0.3125 | 0.3125 | 0.3125 | 0.3125 |
