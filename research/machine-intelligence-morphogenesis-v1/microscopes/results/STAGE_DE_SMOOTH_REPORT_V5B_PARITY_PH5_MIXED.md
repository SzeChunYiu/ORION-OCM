# Stage D'/E' — smooth-generalization ecology: report V5B_PARITY_PH5_MIXED

Target coefficients (none: parity target, PH-5 control). Receipt `STAGE_DE_SMOOTH_V5B_PARITY_PH5_MIXED.json` (sha256 `4e1625bc89bb17bb…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
