# Stage D'/E' — smooth-generalization ecology: report V34_SYM9_H

Target coefficients [0.5625, 0.5625, 0.5625, 0.5625]. Receipt `STAGE_DE_SMOOTH_V34_SYM9_H.json` (sha256 `c4044a91126b0ec7…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).

## Capability after the protocol (largest ladder size, by column)

| row | B0 | B1 | B2 | B3 | U | P3 |
|---|---|---|---|---|---|---|
| S4@4 | 0.599 | 0.599 | 0.599 | 0.599 | 0.599 | 0.599 |
| S2a@4 | 0.9167 | 0.9167 | 0.9167 | 0.9167 | 0.9167 | 0.9167 |
| S5h@4 | 0.8125 | 0.8125 | 0.8125 | 0.8125 | 0.8125 | 0.8125 |
| S5@4 | 0.25 | 0.25 | 0.25 | 0.25 | 0.25 | 0.25 |
