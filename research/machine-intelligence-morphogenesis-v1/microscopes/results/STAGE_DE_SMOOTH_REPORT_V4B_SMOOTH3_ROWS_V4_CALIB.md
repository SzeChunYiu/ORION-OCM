# Stage D'/E' — smooth-generalization ecology: report V4B_SMOOTH3_ROWS_V4_CALIB

Target coefficients [0.5, 0.25, -0.5, 0.375]. Receipt `STAGE_DE_SMOOTH_V4B_SMOOTH3_ROWS_V4_CALIB.json` (sha256 `c5f86a4d697c0fcf…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
...
| S5k@4 | 0.7083 | 0.7083 | 0.7083 | 0.7083 | 0.7083 | 0.7083 |
