# Stage D'/E' — smooth-generalization ecology: report V34_SYM11_H

Target coefficients [0.6875, 0.6875, 0.6875, 0.6875]. Receipt `STAGE_DE_SMOOTH_V34_SYM11_H.json` (sha256 `222dce8d45d0d928…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).

## Capability after the protocol (largest ladder size, by column)

| row | B0 | B1 | B2 | B3 | U | P3 |
|---|---|---|---|---|---|---|
| S4@4 | 0.4375 | 0.4375 | 0.4375 | 0.4375 | 0.4375 | 0.4375 |
| S2a@4 | 0.8646 | 0.8646 | 0.8646 | 0.8646 | 0.8646 | 0.8646 |
| S5h@4 | 0.7708 | 0.7708 | 0.7708 | 0.7708 | 0.7708 | 0.7708 |
| S5@4 | 0.0833 | 0.0833 | 0.0833 | 0.0833 | 0.0833 | 0.0833 |
