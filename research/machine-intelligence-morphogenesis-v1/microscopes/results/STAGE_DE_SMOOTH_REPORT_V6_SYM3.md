# Stage D'/E' — smooth-generalization ecology: report V6_SYM3

Target coefficients [0.1875, 0.1875, 0.1875, 0.1875]. Receipt `STAGE_DE_SMOOTH_V6_SYM3.json` (sha256 `ec30fc3888930f02…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
...
| S5k@4 | 0.75 | 0.75 | 0.75 | 0.75 | 0.75 | 0.75 |
| S5@4 | 0.75 | 0.75 | 0.75 | 0.75 | 0.75 | 0.75 |
| S3@8 | 0.2812 | 0.2812 | 0.2812 | 0.2812 | 0.2812 | 0.2812 |
