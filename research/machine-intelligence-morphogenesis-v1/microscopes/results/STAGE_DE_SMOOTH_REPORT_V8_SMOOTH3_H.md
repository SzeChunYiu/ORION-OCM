# Stage D'/E' — smooth-generalization ecology: report V8_SMOOTH3_H

Target coefficients [0.5, 0.25, -0.5, 0.375]. Receipt `STAGE_DE_SMOOTH_V8_SMOOTH3_H.json` (sha256 `846e6f7be567885a…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
...
| S5h@4 | 0.901 | 0.901 | 0.9062 | 0.901 | 0.901 | 0.901 |
