# Stage D'/E' — smooth-generalization ecology: report V15_SYM7_ATT

Target coefficients [0.4375, 0.4375, 0.4375, 0.4375]. Receipt `STAGE_DE_SMOOTH_V15_SYM7_ATT.json` (sha256 `09ba5c75c87c81b7…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).

## Capability after the protocol (largest ladder size, by column)

| row | B0 | B1 | B2 | B3 | U | P3 |
|---|---|---|---|---|---|---|
| S4@4 | 0.724 | 0.724 | 0.724 | 0.724 | 0.724 | 0.724 |
| S2a@4 | 0.9375 | 0.9375 | 0.9375 | 0.9375 | 0.9375 | 0.9375 |
| S5h@4 | 0.8542 | 0.8542 | 0.8542 | 0.8542 | 0.8542 | 0.8542 |
| S5a@4 | 0.7708 | 0.7708 | 0.7708 | 0.7708 | 0.7708 | 0.7708 |
| S5@4 | 0.4167 | 0.4167 | 0.4167 | 0.4167 | 0.4167 | 0.4167 |
