# Stage D'/E' — smooth-generalization ecology: report V16_SYM3_HW

Target coefficients [0.1875, 0.1875, 0.1875, 0.1875]. Receipt `STAGE_DE_SMOOTH_V16_SYM3_HW.json` (sha256 `8fd4c14486ccfa96…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).

## Capability after the protocol (largest ladder size, by column)

| row | B0 | B1 | B2 | B3 | U | P3 | HW |
|---|---|---|---|---|---|---|---|
| S4@4 | 0.8854 | 0.8854 | 0.8854 | 0.8854 | 0.8854 | 0.8854 | 0.8854 |
| S2a@4 | 0.9375 | 0.9375 | 0.9375 | 0.9375 | 0.9375 | 0.9375 | 0.9375 |
| S5h@4 | 0.9375 | 0.9375 | 0.9375 | 0.9375 | 0.9375 | 0.9375 | 0.9375 |
| S5@4 | 0.75 | 0.75 | 0.75 | 0.75 | 0.75 | 0.75 | 0.75 |
| S3@8 | 0.2812 | 0.2812 | 0.2812 | 0.2812 | 0.2812 | 0.2812 | 0.2812 |
