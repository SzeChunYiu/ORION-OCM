# Stage D'/E' — smooth-generalization ecology: report V8_SYM5_H

Target coefficients [0.3125, 0.3125, 0.3125, 0.3125]. Receipt `STAGE_DE_SMOOTH_V8_SYM5_H.json` (sha256 `fa1eb317fad631b5…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
