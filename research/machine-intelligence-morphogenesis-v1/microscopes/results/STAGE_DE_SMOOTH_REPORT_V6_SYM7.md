# Stage D'/E' — smooth-generalization ecology: report V6_SYM7

Target coefficients [0.4375, 0.4375, 0.4375, 0.4375]. Receipt `STAGE_DE_SMOOTH_V6_SYM7.json` (sha256 `788dea516e1ff782…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
...
| S5k@4 | 0.4167 | 0.4167 | 0.4167 | 0.4167 | 0.4167 | 0.4167 |
