# Stage D'/E' — smooth-generalization ecology: report V34_SYM4_H

Target coefficients [0.25, 0.25, 0.25, 0.25]. Receipt `STAGE_DE_SMOOTH_V34_SYM4_H.json` (sha256 `8c15fc40b814aed2…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
...
| S3@8 | 0.3333 | 0.3333 | 0.3333 | 0.3333 | 0.3333 | 0.3333 |
