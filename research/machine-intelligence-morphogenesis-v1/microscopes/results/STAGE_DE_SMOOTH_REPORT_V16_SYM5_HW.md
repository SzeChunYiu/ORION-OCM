# Stage D'/E' — smooth-generalization ecology: report V16_SYM5_HW

Target coefficients [0.3125, 0.3125, 0.3125, 0.3125]. Receipt `STAGE_DE_SMOOTH_V16_SYM5_HW.json` (sha256 `66855b37ab4e31c8…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).

## Capability after the protocol (largest ladder size, by column)

| row | B0 | B1 | B2 | B3 | U | P3 | HW |
|---|---|---|---|---|---|---|---|
| S4@4 | 0.7812 | 0.7812 | 0.7812 | 0.7812 | 0.7812 | 0.7812 | 0.7812 |
| S2a@4 | 0.9375 | 0.9375 | 0.9375 | 0.9375 | 0.9375 | 0.9375 | 0.9375 |
| S5h@4 | 0.8958 | 0.8958 | 0.8958 | 0.8958 | 0.8958 | 0.8958 | 0.8958 |
| S5@4 | 0.5833 | 0.5833 | 0.5833 | 0.5833 | 0.5833 | 0.5833 | 0.5833 |
| S3@8 | 0.1354 | 0.1354 | 0.1354 | 0.1354 | 0.1354 | 0.1354 | 0.1354 |
...
- **HW**: NOT_OBSERVABLE__NO_DENSE_ROW_ON_FRONTIER (dense rows below theta or dominated at r=0) — winners by r at H=16: {'0': ['S2a'], '1': ['S5h'], '2': ['S5h'], '4': ['S5h'], '8': ['S5h'], '16': ['S5h'], '32': ['S5h']}
