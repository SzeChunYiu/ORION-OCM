# Stage D'/E' — smooth-generalization ecology: report V8_SYM8_H

Target coefficients [0.5, 0.5, 0.5, 0.5]. Receipt `STAGE_DE_SMOOTH_V8_SYM8_H.json` (sha256 `68c601a95d2df703…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
...
| S3@8 | 0.25 | 0.25 | 0.25 | 0.25 | 0.25 | 0.25 |
