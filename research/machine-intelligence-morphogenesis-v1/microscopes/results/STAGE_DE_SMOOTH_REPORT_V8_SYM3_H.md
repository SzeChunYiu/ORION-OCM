# Stage D'/E' — smooth-generalization ecology: report V8_SYM3_H

Target coefficients [0.1875, 0.1875, 0.1875, 0.1875]. Receipt `STAGE_DE_SMOOTH_V8_SYM3_H.json` (sha256 `d7b9ba1280197743…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
