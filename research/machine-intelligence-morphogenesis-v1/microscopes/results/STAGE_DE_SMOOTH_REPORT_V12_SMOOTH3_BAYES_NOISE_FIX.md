# Stage D'/E' — smooth-generalization ecology: report V12_SMOOTH3_BAYES_NOISE_FIX

Target coefficients [0.5, 0.25, -0.5, 0.375]. Receipt `STAGE_DE_SMOOTH_V12_SMOOTH3_BAYES_NOISE_FIX.json` (sha256 `779b61406cbc1bdc…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
...
| S7@16 | 0.8281 | 0.8281 | 0.8281 | 0.8281 | 0.8281 | 0.8281 |
| S5h@4 | 0.8802 | 0.8802 | 0.8802 | 0.8802 | 0.8802 | 0.8802 |
