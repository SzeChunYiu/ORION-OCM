# Stage D'/E' — smooth-generalization ecology: report V20_SYM5_S1

Target coefficients [0.3125, 0.3125, 0.3125, 0.3125]. Receipt `STAGE_DE_SMOOTH_V20_SYM5_S1.json` (sha256 `fcce241d7ca90e1f…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
