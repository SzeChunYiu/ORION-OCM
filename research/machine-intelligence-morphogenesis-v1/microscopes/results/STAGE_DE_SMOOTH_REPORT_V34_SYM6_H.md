# Stage D'/E' — smooth-generalization ecology: report V34_SYM6_H

Target coefficients [0.375, 0.375, 0.375, 0.375]. Receipt `STAGE_DE_SMOOTH_V34_SYM6_H.json` (sha256 `531197614ba8c575…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).

## Capability after the protocol (largest ladder size, by column)

| row | B0 | B1 | B2 | B3 | U | P3 |
|---|---|---|---|---|---|---|
| S4@4 | 0.75 | 0.75 | 0.75 | 0.75 | 0.75 | 0.75 |
| S2a@4 | 0.9167 | 0.9167 | 0.9167 | 0.9167 | 0.9167 | 0.9167 |
| S5h@4 | 0.875 | 0.875 | 0.875 | 0.875 | 0.875 | 0.875 |
| S5@4 | 0.5 | 0.5 | 0.5 | 0.5 | 0.5 | 0.5 |
| S3@8 | 0.2292 | 0.2292 | 0.2292 | 0.2292 | 0.2292 | 0.2292 |
