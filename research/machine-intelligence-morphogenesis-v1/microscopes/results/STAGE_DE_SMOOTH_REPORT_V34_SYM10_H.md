# Stage D'/E' — smooth-generalization ecology: report V34_SYM10_H

Target coefficients [0.625, 0.625, 0.625, 0.625]. Receipt `STAGE_DE_SMOOTH_V34_SYM10_H.json` (sha256 `de8edb2973f013c1…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).

## Capability after the protocol (largest ladder size, by column)

| row | B0 | B1 | B2 | B3 | U | P3 |
|---|---|---|---|---|---|---|
| S4@4 | 0.4896 | 0.4896 | 0.4896 | 0.4896 | 0.4896 | 0.4896 |
| S2a@4 | 0.875 | 0.875 | 0.875 | 0.875 | 0.875 | 0.875 |
| S5h@4 | 0.7917 | 0.7917 | 0.7917 | 0.7917 | 0.7917 | 0.7917 |
| S5@4 | 0.1667 | 0.1667 | 0.1667 | 0.1667 | 0.1667 | 0.1667 |
