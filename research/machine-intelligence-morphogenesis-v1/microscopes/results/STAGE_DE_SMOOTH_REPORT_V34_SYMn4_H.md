# Stage D'/E' — smooth-generalization ecology: report V34_SYMn4_H

Target coefficients [-0.25, -0.25, -0.25, -0.25]. Receipt `STAGE_DE_SMOOTH_V34_SYMn4_H.json` (sha256 `fda320cb3959cace…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).

## Capability after the protocol (largest ladder size, by column)

| row | B0 | B1 | B2 | B3 | U | P3 |
|---|---|---|---|---|---|---|
| S4@4 | 0.7552 | 0.7552 | 0.7552 | 0.7552 | 0.7552 | 0.7552 |
