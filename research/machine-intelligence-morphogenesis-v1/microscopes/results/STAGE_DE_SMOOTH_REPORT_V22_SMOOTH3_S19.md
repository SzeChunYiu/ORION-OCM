# Stage D'/E' — smooth-generalization ecology: report V22_SMOOTH3_S19

Target coefficients [0.5, 0.25, -0.5, 0.375]. Receipt `STAGE_DE_SMOOTH_V22_SMOOTH3_S19.json` (sha256 `29c6d807cef57877…`). 16 inputs, 8 seen; θ = 0.85; rows S4 (gradient net), S2 (exact linear search, grammar of 2401), S5 (exemplar memory), S3 (particles over the grammar).
...
| S3@8 | 0.6667 | 0.6667 | 0.6667 | 0.6667 | 0.6667 | 0.6667 |
