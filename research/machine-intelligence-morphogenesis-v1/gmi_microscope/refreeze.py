...
DEFAULT_NEW = [
    ...
    "REVIVAL_LEDGER.jsonl", "CLAIM_LADDER_V4.json", "GMI_NOTE_QUESTIONS_STATUS_V1.md", "GMI_EXPERIMENT_PROGRAMME_V2_EXECUTED_LANE.md", "THEOREM_REGISTRY_CANONICAL_377.json",
]
