...
ROOT=os.path.dirname(os.path.dirname(os.path.abspath(__file__)));OUT=os.path.join(ROOT,"GMI_K4_PUBLIC_BEACON_V7.json");FREEZE_COMMIT="b80ef413417a076066f5da37ce8f9b59436211f7";CHAIN_HASH="52db9ba70e0cc0f6eaf7803dd07447a1f5477735fd3f661792ba94600c84e971";GENESIS,PERIOD,DELAY=1692803367,3,900;BASE=f"https://api.drand.sh/{CHAIN_HASH}/public"
...
def main():
 if os.path.exists(OUT):raise SystemExit("K4 V7 beacon exists; no-reroll")
