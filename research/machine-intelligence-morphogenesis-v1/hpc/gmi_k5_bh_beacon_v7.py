...
ROOT=os.path.dirname(os.path.dirname(os.path.abspath(__file__)));OUT=os.path.join(ROOT,"GMI_K5_BH_PUBLIC_BEACON_V7.json");FREEZE_COMMIT="5664aaa7b54573442f03be59b5ced208354848b3";CHAIN_HASH="52db9ba70e0cc0f6eaf7803dd07447a1f5477735fd3f661792ba94600c84e971";GENESIS,PERIOD,DELAY=1692803367,3,900;BASE=f"https://api.drand.sh/{CHAIN_HASH}/public"
...
def main():
    if os.path.exists(OUT):raise SystemExit("K5 V7 beacon exists; no-reroll")
