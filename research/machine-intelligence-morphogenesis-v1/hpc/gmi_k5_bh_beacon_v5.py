#!/usr/bin/env python3
"""Acquire the unique future drand quicknet beacon committed by K5 B-H execution freeze V5."""
from __future__ import annotations
import datetime as dt,hashlib,json,os,subprocess,time,urllib.request
ROOT=os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
OUT=os.path.join(ROOT,"GMI_K5_BH_PUBLIC_BEACON_V5.json")
FREEZE_COMMIT="30b6c2bd8a3d63c539163f91d86ff488e1da07ad"
...
def main():
    if os.path.exists(OUT): raise SystemExit("K5 V5 beacon receipt exists; no-reroll rule forbids overwrite")
    ...
    rec={"schema":"GMIK5BHPublicBeaconV5","status":"ACQUIRED_NO_REROLL","no_reroll":True,"execution_freeze_commit":FREEZE_COMMIT,
