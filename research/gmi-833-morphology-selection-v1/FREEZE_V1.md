...
This tranche targets exactly two still-open proof-only rows: positive-mass
niche-partition coexistence and nonnegative vector-resource repricing
transitions.
...
- exact integer/rational arithmetic only; booleans and binary floats fail
  closed;
...
Allowed terminal only after exact replay:
