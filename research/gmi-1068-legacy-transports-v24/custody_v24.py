...
PACKAGE = "research/gmi-1068-legacy-transports-v24"
FREEZE = "dec818e7acbdb270251caae72507e4e49e3fd1f4"
FREEZE_SHA = "badddb8fde62c50cc4243c6759006244ea5afd7ac3a346a815626c795f1cfef5"
RECEIPTS = (
    "research/gmi-1068-affine-regimes-v23/RESULT_V23.json",
...
def verify(root):
    ...
    frozen = git(root, "show", FREEZE + ":" + PACKAGE + "/FREEZE_V24.md")
    ...
    if inventory.stdout.decode().splitlines() != [PACKAGE + "/FREEZE_V24.md"]:
        raise ValueError("outcome artifacts already present at preregistration")
    freeze_path = root / PACKAGE / "FREEZE_V24.md"
    ...
    bindings[PACKAGE + "/FREEZE_V24.md"] = FREEZE_SHA
