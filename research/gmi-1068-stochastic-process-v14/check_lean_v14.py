...
from proof_contract_v14 import ENTRIES, SOURCE_NAMES, audit_source
...
def evaluate():
    ...
    bindings = {}
    audit = audit_source()
    with tempfile.TemporaryDirectory(prefix="gmi-v14-lean-") as output:
        ...
        audit_path = Path(output) / "RegisteredProofsV14.lean"
