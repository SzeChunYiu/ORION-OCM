...
spec = importlib.util.spec_from_file_location("coverage_v14", HERE / "coverage_v14.py")
...
class CoverageTests(unittest.TestCase):
    def test_omissions_aliases_and_corruptions(self):
        ...
        with self.assertRaises(ValueError):
            guard.validate_coverage(bad)
        rejected += 1
        self.assertEqual(rejected, guard.REQUIRED["test_coverage_v14"]["coverage_guard_rejections"])
