...
from proof_contract_v11 import ENTRIES, audit_source

HERE = Path(__file__).resolve().parent
ROOT = HERE.parents[1]
SOURCES = (
    HERE / "TypedPathsV11.lean",
    HERE / "QuotientPathsV11.lean",
    ROOT / "research/gmi-1068-r0-foundation-repair-v9/RecoverabilityV9.lean",
)
...
def evaluate():
    ...
    bindings = {}
    audit = audit_source()
    with tempfile.TemporaryDirectory(prefix="gmi-v11-lean-") as output:
        ...
        audit_path = Path(output) / "RegisteredProofsV11.lean"
