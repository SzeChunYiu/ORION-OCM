...
from proof_contract_v17 import ENTRIES, SOURCE_NAMES, SOURCE_PATHS, audit_source
...
def evaluate():
    ...
    audit = audit_source()
    try:
        with tempfile.TemporaryDirectory(prefix="gmi-v17-lean-") as output:
            ...
            audit_path = Path(output) / "RegisteredProofsV17.lean"
