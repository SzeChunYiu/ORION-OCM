...
FREEZE = "026149d1eb10cba521c5be2911dd8dd17c1e0d04"
FREEZE_SHA = "bbcbc2984380877a96d229d2c3888b604f170cc1f129af48a77efd03daefd848"
RECEIPTS = (
    "research/gmi-1068-partial-context-v15/RESULT_V15.json",
...
def verify(root):
    ...
    frozen = git(root, "show", FREEZE + ":" + PACKAGE + "/FREEZE_V17.md")
    ...
    if inventory.stdout.decode().splitlines() != [PACKAGE + "/FREEZE_V17.md"]:
        raise ValueError("outcome artifacts already present at preregistration")
    freeze_path = root / PACKAGE / "FREEZE_V17.md"
    ...
    bindings[PACKAGE + "/FREEZE_V17.md"] = FREEZE_SHA
