...
Output: k08_repair_batch2_v3.json (single summary stdout line).
"""
...
(HERE / "k08_repair_batch2_v3.json").write_text(json.dumps(result, indent=1))
print("K08_REPAIR_BATCH2_DONE recipe", recipe_used, "broken_errs", broken_errs,
