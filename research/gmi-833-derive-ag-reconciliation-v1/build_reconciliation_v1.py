...
ENTRIES = [
    {"row_index": 14, "comment_id": 5693520829, "bucket": "EXACT-FORMAL",
     ...
     "evidence": (
         ...
         "pairs presenting different objects, fixed overhead is a tolerance rather than an "
         "equivalence with an explicit non-transitive triple at k = 1, and the one named "
    ...
    {"row_index": 41, "comment_id": 5693520829, "bucket": "NEW-SCIENCE",
     ...
     "evidence": (
         ...
         "with 0 predicate-free blind covers, adaptation likewise in 882/882, "
