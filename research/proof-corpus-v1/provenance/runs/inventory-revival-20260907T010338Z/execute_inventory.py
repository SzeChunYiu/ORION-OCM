...
run=root/"provenance/runs/inventory-revival-20260907T010338Z"
...
acquired=json.loads(Path(launch["acquisition_receipt"]).read_text())
...
"acquisition_receipt_sha256":sha256(Path(launch["acquisition_receipt"]).read_bytes()),
