...
import custody_v28 as core
COVERAGE={}


@contextmanager
def overlay(verified):
    with tempfile.TemporaryDirectory(prefix='gmi-v28-custody-') as temporary:
        root=Path(temporary)
...
class CustodyTests(unittest.TestCase):
    def test_real_inherited_inputs_and_tampering(self):
        ...
        files=('research/gmi-1068-typed-foundation-v11/paths_v11.py',
               ...
               'research/gmi-1068-parent-translations-v27/lts_v27.py',
               'research/gmi-1068-r2-context-irreducibility-v1/ContextIrreducibility.lean',
               'research/gmi-1068-recursive-audit-v27/SCOPE_SNAPSHOT_V27.json',
               'research/gmi-1068-r2-context-irreducibility-v1/THEORY_V1.md',
               'research/gmi-1068-amendment-governance-v16/AMENDMENT_LEDGER_V16.json',
               *core.RECEIPTS,core.PACKAGE+'/FREEZE_V28.md',core.PACKAGE+'/SOURCE_PINS_V28.json')
        rejected=0
        for name in files:
            with overlay(valid) as root:
                ...
                rejected+=1
        with overlay(valid) as root:
            target=root/'research/gmi-1068-parent-translations-v27/lts_v27.py'
            target.write_bytes(target.read_bytes()+b'\n')
            path=root/core.RECEIPTS[0]
            receipt=json.loads(path.read_text())
            receipt['inputs']['lts_v27.py']=core.digest(target)
    ...
    def test_unavailable_inputs_and_path_escape(self):
        valid=core.verify(ROOT)
        missing=0
        for name in ('research/gmi-1068-parent-translations-v27/lts_v27.py',
                     'research/gmi-1068-partial-context-v15/context_v15.py',
                     core.PACKAGE+'/FREEZE_V28.md',core.PACKAGE+'/SOURCE_PINS_V28.json',core.RECEIPTS[2]):
            with overlay(valid) as root:
                (root/name).unlink()
