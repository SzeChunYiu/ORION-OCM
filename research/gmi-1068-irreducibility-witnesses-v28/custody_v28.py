...
FREEZE = "513cfeed50077f3bf3964eb07193f9f52678f74f"
FREEZE_SHA = "46066fdb3eb8cec85cda20ca9af75aa62a2514dae98d51cde2767defc735963d"
PINS_SHA = "f676f1c67f608e8478a4600d399666ea22c9833d7a4d1b740cbce9bfffb40ca3"
RECEIPTS = (
    "research/gmi-1068-parent-translations-v27/RESULT_V27.json",
...
def verify(root):
    ...
    frozen = git(root, "show", FREEZE + ":" + PACKAGE + "/FREEZE_V28.md")
    ...
    names = ["FREEZE_V28.md", "SOURCE_PINS_V28.json"]
    ...
    if manifest["schema"] != "GMI_1068_IRREDUCIBILITY_SOURCE_PINS_V28":
        raise ValueError("source manifest schema")
    bindings = dict(manifest["pins"])
    if len(bindings) != 31 or len(manifest["lean_source_order"]) != 9 or len(manifest["python_source_paths"]) != 9:
