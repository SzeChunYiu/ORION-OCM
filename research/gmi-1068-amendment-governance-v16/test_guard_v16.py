...
spec = importlib.util.spec_from_file_location("governance_coverage_v16", HERE / "governance_coverage_v16.py")
...
class CoverageTests(unittest.TestCase):
    def test_omissions_aliases_and_corruptions(self):
        ...
        with self.assertRaises(ValueError):
            guard.validate_coverage(bad)
        rejected += 1
        self.assertEqual(rejected, guard.REQUIRED["test_guard_v16"]["coverage_guard_rejections"])
