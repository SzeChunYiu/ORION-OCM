...
from proof_contract_v13 import ENTRIES, SOURCE_NAMES, audit_source
...
def evaluate():
    ...
    bindings = {}
    audit = audit_source()
    with tempfile.TemporaryDirectory(prefix="gmi-v13-lean-") as output:
        ...
        audit_path = Path(output) / "RegisteredProofsV13.lean"
