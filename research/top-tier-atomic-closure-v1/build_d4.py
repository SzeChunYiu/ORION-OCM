...
HOSTILES = [
    ...
    {"hostile_id": "H-MV-05", "target": "benchmark truth labels for E3+ studies",
     ...
     "status": "DESIGNED_PENDING", "outcome": "GATE REGISTERED, E3 EXECUTION PENDING",
     "receipt": "issue #165 section 16: independent-authorship/benchmark-circularity gate; independently authored world families still open for E3+"},
...
suite = {
    ...
    "self_test": {
        ...
        "unexecuted_members_admitted": ["H-MV-05 (E3 independent authorship pending)", "H-MV-12 (k/N unbound)"],
    },
