...
DESIGN = {
    ...
    "closure_plan_ref": "research/top-tier-atomic-closure-v1/GATE_CLOSURE_PLAN.md (TTAC-D7b): for every open blocking-gate sub-item (G2.4 complete, G3.2 scoped failure memory, G3.3 representation change, G3.4 insufficiency-diagnosis loop, two-domain same core) the specific executable study, its registered scope and its owner lane — three of them are executions of already-frozen protocols (g2-length-scaling-v1, g3-scoped-failure-memory-v1 PROTOCOL.md + REPRESENTATION_PROTOCOL.md); none authorizes a flagship run",
    "arms": [
