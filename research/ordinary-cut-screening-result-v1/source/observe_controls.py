...
paths=[ROOT/"check_integration.py",Path(__file__).resolve(),Path(sys.executable).resolve()]
paths+=list((ROOT/"source").glob("*.py"))+[ROOT/"run_screening.py"]
...
argv=[sys.executable,"-I","-S","-B",str(ROOT/"check_integration.py"),str(OUT)]
...
receipt={"schema":"ordinary.screening-integration-process.v1","observer_pid":os.getpid(),
