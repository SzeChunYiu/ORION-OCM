...
EXPECTED_REQUEST = {'bytes': 12127, 'sha256': '240998a5c5a6b529d9bc561e444661c2563d46478a39e4942bd8a5664abd6cb3'}
...
def run():
    ...
    assert contract["sources"] == request["sources"] and len(request["sources"]) == 10
    pins = {}
    ...
    for key in ("manifest", "wheel"):
        ...
        pin(value["path"], value)
    assert set(gate["accepted_reviews"]) == {"screening_source", "observer_source"}
