...
The [continuous lift](CONTINUOUS_LIFT_BOUNDARY_THEOREM_V1.md) separates
order-theoretic lower-bound transport from attainment and effective
optimization. Exact tightness needs a matching construction; constructive
epsilon-optima can remain available without attainment. Boolean declarations
do not discharge the mathematical premises or measurement obligations.
