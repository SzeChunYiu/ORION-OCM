...
labelled-partition query reconstruction, and finite fixed-unknown-model
acquisition with charged private randomization. The active
aggregate is `GRAND_GMI_MASTER_RECEIPT_V8.json`. Earlier aggregates and phase-law receipts
remain preserved; exact pre-overwrite upstream aggregate bytes have separate
historical paths. The current register has 63 checkers (62 leaves and one
