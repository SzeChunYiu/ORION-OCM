#!/usr/bin/env python3
"""Hostile candidate expansion: exact parity-3, frozen V4.

The preregistration is NN_NONNN_POINT_PARITY3_PREREG_V4.json. This harness uses
...
PREREG = HERE / "NN_NONNN_POINT_PARITY3_PREREG_V4.json"
...
def validate_preregistration(prereg):
    require(prereg.get("schema") == "NN_NONNN_POINT_PARITY3_PREREG_V4", "wrong prereg schema")
    ...
    require(prereg.get("independent_prospective_prediction") is False,
            "V4 must disclose that V1 and V2 outcomes were read")
...
def deterministic_self_test() -> dict:
    ...
    return {
        "terminal": "PARITY3_V4_INSTRUMENT_SELF_TEST_GREEN",
...
def run_experiment() -> dict:
    ...
    packet = {
        "schema": "NN_NONNN_POINT_PARITY3_RESULT_V4",
