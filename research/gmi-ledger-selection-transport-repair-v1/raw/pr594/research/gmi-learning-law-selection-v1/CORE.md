# Learning-law selection: read first

Ledger item 7. `OPTIMIZATION.md` already derives gradient descent (O1), mirror
descent (O2) and Bayesian updating (O3) — each *from* a premise. O0 names the
