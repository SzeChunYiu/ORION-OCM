...
def main(request_path,output):
    ...
    if request.get("schema")!="ordinary.training-opportunity-request.v2":raise ValueError("opportunity request schema")
    ...
    output.mkdir()
    result={"schema":"ordinary.training-only-opportunity.v2","roots":[],"native_calls":0,"pid":os.getpid(),
