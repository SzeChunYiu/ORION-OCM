...
from proof_contract_v18 import ENTRIES, SOURCE_NAMES, SOURCE_PATHS, audit_source
...
def evaluate():
    ...
    audit = audit_source()
    try:
        with tempfile.TemporaryDirectory(prefix="gmi-v18-lean-") as output:
            ...
            audit_path = Path(output) / "RegisteredProofsV18.lean"
