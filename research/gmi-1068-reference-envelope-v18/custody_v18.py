...
FREEZE = "12d4aaa003f7706266467cb5352792ef6957eb7c"
FREEZE_SHA = "6fb0b0cdf2f81e5a142004e243ab87bf7a3cb2d3471b3db01791fedd97447f80"
RECEIPTS = (
    "research/gmi-1068-context-specializations-v17/RESULT_V17.json",
...
def verify(root):
    ...
    frozen = git(root, "show", FREEZE + ":" + PACKAGE + "/FREEZE_V18.md")
    ...
    if inventory.stdout.decode().splitlines() != [PACKAGE + "/FREEZE_V18.md"]:
        raise ValueError("outcome artifacts already present at preregistration")
    freeze_path = root / PACKAGE / "FREEZE_V18.md"
    ...
    bindings[PACKAGE + "/FREEZE_V18.md"] = FREEZE_SHA
