...
FREEZE = "967231aaa8063db732b2264984cce93727e73ca4"
FREEZE_SHA = "771b5fed33127e730d08a6309bfac95ccf69524065d59c39c2570b21c43a4be6"
RECEIPTS = (
    "research/gmi-1068-legacy-transports-v24/RESULT_V24.json",
...
def verify(root):
    ...
    frozen = git(root, "show", FREEZE + ":" + PACKAGE + "/FREEZE_V25.md")
    ...
    if inventory.stdout.decode().splitlines() != [PACKAGE + "/FREEZE_V25.md"]:
        raise ValueError("outcome artifacts already present at preregistration")
    freeze_path = root / PACKAGE / "FREEZE_V25.md"
    ...
    bindings[PACKAGE + "/FREEZE_V25.md"] = FREEZE_SHA
