...
def test_changed_query_config_state_and_unregistered_revocation_cannot_reuse_binding():
    ...
    variants = [dict(task=replace(p.fixture["task"], task_id="changed-query", parts=(replace(p.fixture["task"].parts[0], refs=("background_0",)),))),
