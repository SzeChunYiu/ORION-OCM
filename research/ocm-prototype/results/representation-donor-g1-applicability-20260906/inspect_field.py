...
# Reuse the frozen zero-based outer ledger verifier; do not duplicate its format.
ledger=[asdict(entry) for entry in LedgerStore(ROOT/"input/ocm-state").entries()]
