...
out=root/'research/ocm-prototype/results/surprise-channel-integration-20260906'
raw=out/'raw'
...
record={'checks':checks,'current':current,'current_verification':value,
        ...
        'solve_vendor_targets':[x for x in json.loads((root/'docs/provenance/VENDORED_SOURCE_MANIFEST_CURRENT.json').read_text())['files'] if x['target_path']=='src/ocm/runtime/solve.py'],
