...
import g1_vessel
from g1_field import CLIA, MODEL, ROOT, SCOPE, encode, payload, put
...
def apply(runtime, request):
    ...
    try:
        ...
        # The received query is data; execution still requires the descriptor's live support.
        put(runtime, qid, request, WarrantProfile.one(), (ROOT, atom_id(desc['id'])), kind='query_seed')
