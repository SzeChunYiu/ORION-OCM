...
def emit(root):
    ...
    origins["vendor.conll18_ud_eval"]={"path":"/SYNTHETIC/vendor/conll18_ud_eval.py","sha256":"SYNTHETIC"}
    ...
    for a in assignments:
        ...
        base={"modules":{n:origins[n] for n in names[:5]+["vendor.conll18_ud_eval"]},"external":{"z3":runtime["z3"]},"sympy_imported":False,"sympy_module_count":0}
