...
def example_meanings() -> dict[str, MeaningGraph]:
    ...
    return {
        ...
        "which door did it open": MeaningGraph((it, door, opened, which), (MEdge("ROLE:agent", ("open",), ("it",)), MEdge("ROLE:patient", ("open",), ("door",)), MEdge("ASKS", ("which",), ("door",)), MEdge("TENSE", ("open",), ("open",), "past")), root="open"),
    }
