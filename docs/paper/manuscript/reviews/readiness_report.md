...
## Round 3 addendum (2026-09-06)

All round-3 items applied except the persistent identifier (R3-r3-3, pre-submission action). V5 is reported beside the acceptance ledger's label; attribution to the epistemic layer is declared, not ablated (next study: OCM−Δ arm). Terminal state unchanged: `current_claims_partly_established`.
