#!/usr/bin/env python3
"""Verify the active runtime successor; preserve historical M8_RECEIPT_V1.json.
    python tools/m8_receipt.py --write-current  # create declared successor; never overwrite history
    python tools/m8_receipt.py --verify         # verify active successor; no historical fallback
