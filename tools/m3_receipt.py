#!/usr/bin/env python3
"""Generate or verify docs/provenance/M3_RECEIPT_V1.json.
    python tools/m3_receipt.py            # (re)generate
    python tools/m3_receipt.py --verify   # exit 1 on drift of bound files or deterministic results
